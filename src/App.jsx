                  ...
                  {editingScheduleIndex === -1 ? (
                    <div className="flex items-center">
                      <input
                        ...
                        className="mr-2 px-2 py-1 text-white bg-black/80 border border-edc-purple/50 rounded-md text-sm flex-grow"
                        autoFocus
                        onKeyDown={(e) => {
                          if (e.key === 'Enter') {
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <div className="flex items-center">
                        <div className="flex rounded-md overflow-hidden border border-edc-purple/60 mr-3">
                          <button
                            onClick={() => isManualMode && toggleModeRef.current?.toggle()}
                            className={`px-3 py-1 text-xs font-medium transition-all ${!isManualMode 
                              ? 'bg-edc-purple text-white font-medium' 
                              : 'bg-black/30 text-white/60 hover:text-white/80'}`}
                          >
                            Image Upload
                          </button>
                          <button
